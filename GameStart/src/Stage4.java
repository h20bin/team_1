 ...
 // 유틸리티 메서드: 스프라이트 시트를 로드합니다.
    ...
    private void initializeStage(int stageNum) {
        ...
        for (int i = 0; i < stageNum*20; i++) {
            ...
            switch (i % 4) {
                case 0: // 직선 배열
                    enemy = new Enemy(50 + (i * 40), -100, 50, enemySprite4, null);
                    break;

                case 1: // 지그재그 배열
                    enemy = new Enemy(50 + (i % 2 == 0 ? i * 40 : -i * 40), -100 - (i * 80), 50, enemySprite1, null);
                    break;
                ...
                case 2: // 원형 배열
                    ...
                    enemy = new Enemy(x, y, 50, enemySprite2, null);
                    break;
