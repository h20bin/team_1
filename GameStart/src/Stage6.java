...
public class Stage6 extends JPanel implements ActionListener, KeyListener {
    ...
    public Stage6 (GameManager manager, int stageNum) {
    ...
    private void initializeStage(int stageNum) {
        ...
        for (int i = 0; i < stageNum*30; i++) {
            ...
            try {
                ...
                enemySprite2 = new SpriteSheet("/Weapon/ball1.png", 72, 108).getFrame(0);
